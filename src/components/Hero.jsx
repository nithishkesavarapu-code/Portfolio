...
export default function Hero() {
  return (
    <motion.section
      ...
      initial="hidden"
      animate="show"
      className="relative min-h-screen flex items-center mb-32 overflow-hidden w-full"
    >
      ...
      <div className="max-w-6xl mx-auto w-full px-6 flex flex-col md:flex-row items-center justify-between gap-16 xl:pr-12">
        ...
        <motion.div
          variants={imageAnim}
          className="relative flex items-center justify-center z-10 shrink-0 right-0 md:pr-10 lg:pr-20"
        >
          <motion.div
            animate={{ y: [0, -12, 0] }}
